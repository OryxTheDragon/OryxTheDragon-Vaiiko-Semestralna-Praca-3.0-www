        ...
        <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
            <ul class="navbar-nav">
                ...
                <form method="redirectPrihlasenie">
                    <li class="nav-item">
                        <button class="btn btn-secondary btn" type="submit" name="redirectPrihlasenie" value="redirectPrihlasenie">Prihlasit</button>
                    </li>
                </form>
                <?php } ?>
        ...
        <div class="col-xs-2"></div>
            <div class="col-xs-2">
                <form method="get" class="username" name="registracia" onsubmit="return validaciaRegistracie()">
                    ...
                    <input class="mb-4 form-control" type="password" id="password" name="password"  placeholder="Password">
                        <form><p><input type="checkbox" name="checkbox" value="check" />   Potvrdzujem, ze suhlasim s <script>makeLink()</script></p>
                            <button onclick="if(!this.form.checkbox.checked){alert('Najprv musite odsuhlasit privacy policy!');return false}" class="btn btn-primary btn" type="submit" name="registrovat" value="registrovat">Registrovat</button>
                        </form>
                </form>
            </div>
        <div class="col-xs-2"></div>
...
//
//    /** @var User $user */
//foreach ($app->getAllData() as $user) {
//        echo "<h2>".$user->getUsername()."</h2>";
//        echo "<small>".$user->getPassword()."</small>";
//        echo "<hr>";
//    }
//
?>
