        ...
        <div class="row">
            <div class="col-xs-2">
                <form method="zmenitHeslo" class="username">
                    ...
                    <input type="password" class="form-control mb-2" name="oldPassword" id="oldPassword" placeholder="Old password">
                    ...
                    <button class="btn btn-primary btn " type="submit" name="zmenitHeslo" value="zmenitHeslo">Zmenit Heslo</button>
                </form>
            </div>
